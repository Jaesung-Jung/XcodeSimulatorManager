...
Systematically scan Apple's developer documentation via the Sosumi MCP, identify deprecated SwiftUI APIs and their modern replacements, and update `swiftui/references/latest-apis.md`.
...
Read `swiftui/references/latest-apis.md` to understand:
...
2. Commit changes to `swiftui/references/latest-apis.md`.
