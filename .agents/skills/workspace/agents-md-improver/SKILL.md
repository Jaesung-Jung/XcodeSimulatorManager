...
description: Audit and improve AGENTS.md files in repositories. Use when user asks to check, audit, update, improve, or fix AGENTS.md files. Scans for all AGENTS.md files, evaluates quality against templates, outputs quality report, then makes targeted updates. Also use when the user mentions "AGENTS.md maintenance" or "Codex project instructions".
---

# AGENTS.md Improver

Audit, evaluate, and improve AGENTS.md files across a codebase to ensure Codex has optimal project instructions.
...
|------|----------|---------|
| Project root | `./AGENTS.md` | Primary Codex instructions (checked into git, shared with team) |
| Package-specific | `./packages/*/AGENTS.md` | Module-level instructions in monorepos |
