---
name: swift-style
description: Swift code style conventions for clean, readable code. Use for style-focused cleanup or review passes where formatting, naming, organization, and idiomatic conventions are the primary concern. Do not use this as the main skill for concurrency, networking, persistence, testing, or other domain-specific design work.
---
...
Use this skill as a style-focused final pass, not as a substitute for more specialized Swift skills.
