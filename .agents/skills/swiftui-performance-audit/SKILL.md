...
Use this skill only when performance diagnosis is the main job. For normal SwiftUI implementation, use `swiftui-patterns`.
...
- Image loading and downsampling patterns: `references/image-optimization.md`
